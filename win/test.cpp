...
// Set up device context (DC) for drawing
	...
	for(i = 0; i < 30; i++)
	{
		dc.MoveTo(20 + (i * 10),20);
		dc.LineTo(20 + (i * 10),310);

		dc.MoveTo(20,20 + (i * 10));
		dc.LineTo(311,20 + (i * 10));
	}
	...
	for(i=0;i < 9;i++)
	{
		dc.MoveTo((10 * x) + 21, (10 * y) + 21 + i);
		dc.LineTo((10 * x) + 30, (10 * y) + 21 + i);
	}
